...
module.exports = function createRaveEngine(controls) {
  ...
  const GENRE_SCENES = {
    ...
    pop:    { idle: "idle_soft", flow: "flow_sunset", pulse: "flow_pop" },
    ...
    media:  { idle: "idle_soft", flow: "flow_glacier", pulse: "flow_media" },
...
function getModeSwitchBias() {
  ...
  function emitWiz(now, isBeat) {
    ...
    const saturationBoost = clamp((flowScene ? 0.34 : 0.29) + (motion * 0.2), 0, 0.62);
